    ...
    <aside className="w-[280px] bg-white border-r h-full flex flex-col shrink-0 z-50">
      ...
      <div className="p-8 pb-12">
        <div className="flex items-center gap-3 group cursor-pointer" onClick={() => router.push("/forms")}>
          ...
          <div>
            <h1 className="text-xl font-black text-gray-900 font-display tracking-tight leading-none">Antigravity</h1>
            <p className="text-[10px] text-indigo-500 font-black uppercase tracking-[0.2em] mt-1">API Builder</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gray-50 rounded-[2rem] p-6 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-gray-400 font-bold tracking-tight truncate">pro@antigravity.io</p>
            </div>
          </div>
